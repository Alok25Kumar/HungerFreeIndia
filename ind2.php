...
th{
	...
	<body style="background-image: url(images/backgroundimg.jpeg); background-repeat: cover;">
		...
		<?php
		 ...
		 $result = $mysqli->query("SELECT * FROM volunteer") or die(mysqli_error);
		 //pre_r($result);
		 ?>
		   ...
		   <?php
		 		while ($row = $result->fetch_assoc()): ?>
		 			<tr>
		 				...
		 				<td>
		 					<a href="ind2.php?edit=<?php echo $row['id']; ?>"
		 						class="btn btn-info" style="font-size: 20px;">Edit</a>
		 						<a href="pro2.php?delete=<?php echo $row['id']; ?>"
		...
		<form action="pro2.php" method="POST">
			...
			<input type="text" name="volunteer" class="form-control" value="<?php echo $volunteer; ?>" placeholder="enter the name">
			</div>
			<div class="form-group">
			<label>Details</label>
