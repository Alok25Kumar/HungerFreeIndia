...
<div class="wrapper bgded overlay" style="background-image:url('images/backgrounds/volunteer.jpg');">
  <div id="pageintro" class="hoc clear"> 
    
    <article>
<p>
   Locate Nearby Hunger Spots</br>
...
header("location: moh1.php"); // Redirecting To Profile Page
}
?>
<!DOCTYPE html>
<html>
